...
if (isset($_POST['action'])) {
    if ($_POST['action'] == 'cadastro') {
        ...
        if ($senhaCodificada != $senhaConfirmarCod) {
            ...
            $sql = $connect->prepare("SELECT nomeDoUsuario, emailDoUsuario 
            FROM usuario WHERE nomeDoUsuario = ? OR emailDoUsuario = ?");
            ...
            if ($linha['nomeDoUsuario'] == $nomeDoUsuario) {
                ...
                nomeCompleto, emailDoUsuario, senhaDoUsuario, dataCriado) 
                values(?, ?, ?, ?, ?)");
                $sql->bind_param(
                    "sssss",
                    $nomeDoUsuario,
